...
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
            ...
            //  that toggles the date picker or, if the icon is disabled, relative to the top-right corner or's value as starting date
            ...
            //  if set to TRUE, a date can be set only through the date picker and cannot be f the element
            ...
            //  current date pickeentered manually
            //
            //  default is TRUE
        ...
        var init = function(update) {
            ...
            var html = '' +
                '<div class="Zebra_DatePicker">' +
                    '<div class="dptop"><table class="dp_header">' +
                        '<tr>' +
            ...
            $('.dp_previous', header).bind('click', function() {
                $('.dp_caption span').addClass('anim_bottom');
				$('.dpbottom').addClass('anim_right');
				setTimeout(function(){
					$('.dp_caption span').removeClass('anim_bottom');
					$('.dpbottom').removeClass('anim_right');
				},300);
            ...
            $('.dp_next', header).bind('click', function() {
				$('.dp_caption span').addClass('anim_top');
				$('.dpbottom').addClass('anim_left');
				setTimeout(function(){
					$('.dp_caption span').removeClass('anim_top');
					$('.dpbottom').removeClass('anim_left');
				},300);
                // if view is "months"
                // increment year by 1
                if (view == 'months') selected_year++;
        ...
        var manage_header = function(caption) {
            ...
            $('.dp_caption span', header).html(caption);
